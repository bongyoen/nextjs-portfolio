...
export default function Intro() {
	return (
		<section className="relative flex h-full min-h-screen flex-grow flex-col gap-x-8 py-24">
      ...
      `}>
				{process.env.DB_HOST}
						...
						<div className="my-7 w-max">
							<h1 className={`
                 animate-typing overflow-hidden whitespace-nowrap border-r-8 border-r-black pr-10
     ...
     `}>
                  ...
                  whitespace-nowrap rounded-full px-4 py-2 text-lg font-medium transition-colors
                  hover:shadow-xl
    ...
    `}>
     ...
     `}>
						...
						<Image className="rounded-full object-contain" objectFit="cover" src={MePng} alt="logo" />
					</div>
				</div>
			</div>
		</section>
